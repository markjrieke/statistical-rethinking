...
* The binomial distribution is denoted above, where $y$ is a count ($[\ 0, \infty)$), $p$ is the probability that any particular "trial" is a success, and $n$ is the number of trials. 
